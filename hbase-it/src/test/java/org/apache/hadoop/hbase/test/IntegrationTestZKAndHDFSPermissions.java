...
public class IntegrationTestZKAndHDFSPermissions extends AbstractHBaseTool {

  private static final Log LOG = LogFactory.getLog(IntegrationTestZKAndHDFSPermissions.class);
  private String superUser;
  private String masterPrincipal;
  private boolean isForce;
  private boolean skipHDFSCheck;
  ...
  public static final String SKIP_CHECK_HDFS = "skip_hdfs_check";
  ...
  protected void addOptions() {
    ...
    addOptNoArg(SKIP_CHECK_HDFS, "Whether to skip checking HDFS permissions");
  ...
  protected void processOptions(CommandLine cmd) {
    ...
    skipHDFSCheck = cmd.hasOption(SKIP_CHECK_HDFS);
  ...
  private void assertZnodePerms(RecoverableZooKeeper zk, String znode,
    ...
    LOG.info("Checking ACLs for znode:" + znode + " acls:" + acls);
  ...
  private void testHDFSPerms() throws IOException {
    Path rootDir = FSUtils.getRootDir(conf);
    LOG.info("Checking ACLs for root dir:" + rootDir);
  ...
  public static void main(String[] args) throws Exception {
    ...
    IntegrationTestZKAndHDFSPermissions tool = new IntegrationTestZKAndHDFSPermissions();
